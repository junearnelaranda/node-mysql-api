...
async function register(params: any, origin: any) {
    ...
    try {
        ...
        // Keep local development moving even when SMTP is not configured.
        console.warn('Verification email was not sent:', err.message);
        console.warn(`Use this verification token with POST /accounts/verify-email: ${account.verificationToken}`);
    }
}
